...
def main():
    print("Welcome to Super Duper Mario!\nThis game was inspired by Adventure & Zork."
     "The game begins with you waking up after a rough night of sleep."
     " You rub your eyes and blink a few times, only to realize you are not in your room."
      " As you look around, you notice that you are infact in a Mall.\n")
    curLoc = 0
    curPoints = 0
    loc1 = "You find yourself in a dimly lit mall. The walls are bare, revealing cracked bricks and sheetrock."
    loc2 = "You find yourself in a trench. Dirt, grime, and rocks tumble into the center path as you stand there."
    loc3 = "You find yourself in an air balloon. The fabric seems strained, as if it could rip any moment."
    loc4 = "You find yourself in a pitch black room. There is a single green and red light in the center, dangling from the city."
    for i in range(4):
        if (curLoc == 0):
            print(loc1)
        elif (curLoc == 1):
