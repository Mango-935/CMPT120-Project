...
def change(location, score):
    print("Score: ", score + 5)  # Prints Score
...
def game_loop(player):
    ...
    for i in range(6):
        ...
        while (True):
            action = input("\nWhat would you like to do? Use 'Help' to see "
                           "a list of potential commands: ").lower()
            if (action == "quit"):
                return (None)
            # Receives command input + backs out if 'quit' is entered
            if (curLoc == 0):
                if (action == "help"):  # Gives valid commands
                    print("\nInspect Walls, Move South, Turn on Lights, Quit")
                ...
                if (action == "help"):
                    print("\nFollow the trench, Look Over, Quit")
                ...
                if (action == "help"):
                    print("\nLeave Through Hatch, Steal Lights, Quit")
                ...
                if (action == "help"):
                    print("\nTake Bag, View Books, Enter Next Class, Quit")
                ...
                if (action == "help"):
                    print("\nPull Green Light, Inspect Container, Quit")
